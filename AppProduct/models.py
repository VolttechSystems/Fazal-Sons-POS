...
class TemporaryProduct(models.Model):
    ...
    outlet_name = models.ForeignKey(Outlet, on_delete=models.CASCADE, null=True)
    sub_category_name = models.ForeignKey(SubCategory, on_delete=models.CASCADE, null=True)
    category_name = models.ForeignKey(Category, on_delete=models.CASCADE, null=True)
